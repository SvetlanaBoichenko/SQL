...
SUM ( COALESCE(ds_after.level,0)-COALESCE(ds_before.level,0) )
...
FROM  SQUAD_ACTIVITY
LEFT JOIN SQ_LEADERS SL
LEFT JOIN SQ_EFFECTIVE SF

LEFT JOIN COMBAT_skills cs ON SA.squad_id = cs.squad_id
